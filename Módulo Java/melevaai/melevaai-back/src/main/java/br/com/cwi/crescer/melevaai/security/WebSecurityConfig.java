...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/admin/**", "/v2/api-docs", "/configuration/ui", "/swagger-resources", "/configuration/security", "/swagger-ui.html", "/webjars/**")
                .hasRole("ADMIN")

//                .antMatchers("/webjars/springfox-swagger-ui/**", "/swagger-ui.html", "/swagger-resources/**", "/v2/api-docs/**").permitAll()
                // tudo que estiver a partir de "/passageiros/**"
                .antMatchers(HttpMethod.POST, "/passageiros", "/motoristas", "/login", "/admin").permitAll()
